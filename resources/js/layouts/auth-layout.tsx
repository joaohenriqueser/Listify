                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent className="w-48" align="end">
                                        ...
                                        <DropdownMenuItem asChild>
                                            <Link href={`https://${window.location.host}/account.destroy`} method="post" as="button" className="w-full text-left">
                                                Excluir minha conta
                                            </Link>
                                        </DropdownMenuItem>
                                        <DropdownMenuItem asChild>
                        ...
                        <div className="-me-2 flex items-center sm:hidden">
                            <Button variant="ghost" size="icon" onClick={() => setShowingNavigationDropdown((previousState) => !previousState)} className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
